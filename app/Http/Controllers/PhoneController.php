...
class PhoneController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		$fileSip = fopen("F:/xampp/htdocs/police/resources/views/phone/sip-myol.conf", "a+") or die("Unable to open file!");
		...
		$fileExten = fopen("F:/xampp/htdocs/police/resources/views/phone/extensions-myol.conf", "a+") or die("Unable to open file!");
