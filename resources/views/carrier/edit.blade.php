        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title text-center"><i class="fa fa-pencil"></i> Update <code><b>Carrier</b></code> </h3>
                </div>

                <div class="panel-body">
                     {!! Form::model($carrier, ['url' => "carrier/$carrier->id", 'method' => 'put', 'class' => 'form-horizontal']) !!}
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <h3>Do you want to <b><mark>Update Carrier</mark></b>?</h3>
                                </div>
