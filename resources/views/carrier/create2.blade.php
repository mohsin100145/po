                ...
                <div class="panel-body">
                    ...
                    <div class="thumbnail">
                        ...
                        <div class="required form-group {{ $errors->has('disallow') ? 'has-error' : ''}}">
                            ...
                            <div class="col-xs-9 col-sm-9">
                                <div class="col-xs-12 col-sm-12">
                                    {!! Form::text('disallow', 'all', ['class' => 'form-control', 'id' => 'disallow', 'placeholder' => 'Enter disallow (Example: all)', 'autocomplete' => 'off']) !!}
                                    <span class="text-danger">
                        ...
                        <div class="required form-group {{ $errors->has('type') ? 'has-error' : ''}}">
                            ...
                            <div class="col-xs-9 col-sm-9">
                                <div class="col-xs-12 col-sm-12">
                                    {!! Form::text('type', 'friend', ['class' => 'form-control', 'id' => 'type', 'placeholder' => 'Enter type (Example: friend)', 'autocomplete' => 'off']) !!}
                                    <span class="text-danger">
                                        {{ $errors->first('type') }}
                                    </span>
                                </div>
                        ...
                        <div class="required form-group {{ $errors->has('dtmfmode') ? 'has-error' : ''}}">
                            ...
                            <div class="col-xs-9 col-sm-9">
                                <div class="col-xs-12 col-sm-12">
                                    {!! Form::text('dtmfmode', 'rfc2833', ['class' => 'form-control', 'id' => 'dtmfmode', 'placeholder' => 'Enter dtmfmode (Example: rfc2833)', 'autocomplete' => 'off']) !!}
                                    <span class="text-danger">
                        ...
                        <div class="required form-group {{ $errors->has('context') ? 'has-error' : ''}}">
                            ...
                            <div class="col-xs-9 col-sm-9">
                                <div class="col-xs-12 col-sm-12">
                                    {!! Form::text('context', 'trunkinbound', ['class' => 'form-control', 'id' => 'context', 'placeholder' => 'Enter context (Example: trunkinbound)', 'autocomplete' => 'off']) !!}
                                    <span class="text-danger">
                        ...
                        <div class="required form-group {{ $errors->has('qualify') ? 'has-error' : ''}}">
                            ...
                            <div class="col-xs-9 col-sm-9">
                                <div class="col-xs-12 col-sm-12">
                                    {!! Form::text('qualify', 'yes', ['class' => 'form-control', 'id' => 'qualify', 'placeholder' => 'Enter qualify (Example: yes)', 'autocomplete' => 'off']) !!}
                                    <span class="text-danger">
                        ...
                        <div class="required form-group {{ $errors->has('insecure') ? 'has-error' : ''}}">
                            ...
                            <div class="col-xs-9 col-sm-9">
                                <div class="col-xs-12 col-sm-12">
                                    {!! Form::text('insecure', 'port,invite', ['class' => 'form-control', 'id' => 'insecure', 'placeholder' => 'Enter insecure (Example: port,invite)', 'autocomplete' => 'off']) !!}
                                    <span class="text-danger">
                        ...
                        <div class="required form-group {{ $errors->has('nat') ? 'has-error' : ''}}">
                            ...
                            <div class="col-xs-9 col-sm-9">
                                <div class="col-xs-12 col-sm-12">
                                    {!! Form::text('nat', 'force_rport,comedia', ['class' => 'form-control', 'id' => 'nat', 'placeholder' => 'Enter nat (Example: force_rport,comedia)', 'autocomplete' => 'off']) !!}
                                    <span class="text-danger">
                                        {{ $errors->first('nat') }}
                                    </span>
                                </div>
                        ...
                        <div class="required form-group {{ $errors->has('gsmallow') ? 'has-error' : ''}}">
                            ...
                            <div class="col-xs-9 col-sm-9">
                                <div class="col-xs-12 col-sm-12">
                                    {!! Form::text('gsmallow', 'gsm', ['class' => 'form-control', 'id' => 'gsmallow', 'placeholder' => 'Enter gsmallow (Example: gsm)', 'autocomplete' => 'off']) !!}
                                    <span class="text-danger">
                        ...
                        <div class="required form-group {{ $errors->has('alawallow') ? 'has-error' : ''}}">
                            ...
                            <div class="col-xs-9 col-sm-9">
                                <div class="col-xs-12 col-sm-12">
                                    {!! Form::text('alawallow', 'alaw', ['class' => 'form-control', 'id' => 'alawallow (Example: alaw)', 'placeholder' => 'Enter alawallow', 'autocomplete' => 'off']) !!}
                                    <span class="text-danger">
                        ...
                        <div class="required form-group {{ $errors->has('ulawallow') ? 'has-error' : ''}}">
                            ...
                            <div class="col-xs-9 col-sm-9">
                                <div class="col-xs-12 col-sm-12">
                                    {!! Form::text('ulawallow', 'ulaw', ['class' => 'form-control', 'id' => 'ulawallow', 'placeholder' => 'Enter ulawallow (Example: ulaw)', 'autocomplete' => 'off']) !!}
                                    <span class="text-danger">
                    ...
                    <div class="thumbnail">
                        ...
                        <div class="required form-group {{ $errors->has('AGIexten') ? 'has-error' : ''}}">
                            ...
                            <div class="col-xs-9 col-sm-9">
                                <div class="col-xs-12 col-sm-12">
                                    {!! Form::text('AGIexten', '_33X.,1,AGI(agi://127.0.0.1:4577/call_log)', ['class' => 'form-control', 'id' => 'AGIexten', 'placeholder' => 'Enter AGIexten (Example: _33X.,1,AGI(agi://127.0.0.1:4577/call_log) )', 'autocomplete' => 'off']) !!}
                                    <span class="text-danger">
                        ...
                        <div class="required form-group {{ $errors->has('SETexten') ? 'has-error' : ''}}">
                            ...
                            <div class="col-xs-9 col-sm-9">
                                <div class="col-xs-12 col-sm-12">
                                    {!! Form::text('SETexten', '_33X.,n,SET(CALLERID(num)=09610100333)', ['class' => 'form-control', 'id' => 'SETexten', 'placeholder' => 'Enter SETexten (Example: _33X.,n,SET(CALLERID(num)=09610100333) )', 'autocomplete' => 'off']) !!}
                                    <span class="text-danger">
                        ...
                        <div class="required form-group {{ $errors->has('Dialexten') ? 'has-error' : ''}}">
                            ...
                            <div class="col-xs-9 col-sm-9">
                                <div class="col-xs-12 col-sm-12">
                                    {!! Form::text('Dialexten', '_33X.,n,Dial(SIP/${EXTEN:2}@RND333,,tTo)', ['class' => 'form-control', 'id' => 'Dialexten', 'placeholder' => 'Enter Dialexten (Example: _33X.,n,Dial(SIP/${EXTEN:2}@RND333,,tTo) )', 'autocomplete' => 'off']) !!}
                                    <span class="text-danger">
                        ...
                        <div class="required form-group {{ $errors->has('Hangupexten') ? 'has-error' : ''}}">
                            ...
                            <div class="col-xs-9 col-sm-9">
                                <div class="col-xs-12 col-sm-12">
                                    {!! Form::text('Hangupexten', '_33X.,n,Hangup', ['class' => 'form-control', 'id' => 'Hangupexten', 'placeholder' => 'Enter Hangupexten (Example: _33X.,n,Hangup)', 'autocomplete' => 'off']) !!}
                                    <span class="text-danger">
