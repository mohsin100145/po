    ...
    <div class="row">
        <div class="col-sm-12">
            <h3>
                ...
                Date Wise CDR Report From <mark>{{ $startDate }}</mark> To <mark>{{ $endDate }}</mark>
            ...
            <div class="panel panel-danger">
                <div class="panel-heading">
                    <h3 class="panel-title text-center"><i class="fa fa-list-ul"></i> Date Wise <code><b>CDR</b></code> Report From <code><b>{{ $startDate }}</b></code> To <code><b>{{ $endDate }}</b></code></h3>
                </div>
